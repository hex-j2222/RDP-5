...
fun HexRDPTheme(
    ...
    if (!view.isInEditMode) {
        SideEffect {
            ...
            // On API 35+ (Android 15), edge-to-edge is enforced and setting
            // statusBarColor/navigationBarColor is ignored. Use WindowCompat
            // insets controller for appearance only — no color assignment needed.
